...
const Homefinding = () => {
    ...
    return(
        ...
        <ScrollView style={styles.page}>
            <View style={{flex:1}}>
                <View  style={{borderRadius: 12, padding:0, margin:20, backgroundColor:'#F9F9F9', flex:1 , minWidth:200}} onLayout={onLayout}>
                    <NeuView style={{borderRadius: 12, backgroundColor:'#F9F9F9', flex: 1 , minWidth:200, width:'100%' }} onLayout={onLayout}>
